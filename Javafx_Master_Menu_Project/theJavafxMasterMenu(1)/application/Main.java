...
public class Main extends Application {
	...
	public void start(Stage primaryStageForm) throws Exception {
		...
		var primaryTabPane = new TabPane();
	...
	FileInputStream office365InputStream = new FileInputStream("office.png");
	...
	FileInputStream jetBrainsInputStream = new FileInputStream("jetbrain.png");
	...
	FileInputStream eclipseInputStream = new FileInputStream("eclipse.png");
	...
	FileInputStream textEditorsInputStream = new FileInputStream("notepad.png");
...
//	new TextEditorsTabClass(textEditorsTab).open();
	...
	FileInputStream browserInputStream = new FileInputStream("browser.png");
	...
	FileInputStream visualStudiosInputStream = new FileInputStream("visual.png");
	...
	FileInputStream linksInputStream = new FileInputStream("links.png");

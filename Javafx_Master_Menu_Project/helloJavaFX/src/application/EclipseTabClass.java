...
public void open() throws FileNotFoundException { 
	...
	FileInputStream input = new FileInputStream("bin/button/eclipse.png");
	Image image = new Image(input);

			Button eclipseCandCPP = new Button(" C/C++ ", new ImageView(image)); eclipseCandCPP.setTranslateX(X); eclipseCandCPP.setTranslateY(Y+=25); eclipseCandCPP.setFont(new Font("Arial Rounded MT Bold", 24)); 
			...
			Button eclipseCandCPPEmbbedded = new Button(" Embedded C/C++ ", new ImageView(image)); eclipseCandCPPEmbbedded.setTranslateX(X); eclipseCandCPPEmbbedded.setTranslateY(Y+=100); eclipseCandCPPEmbbedded.setFont(new Font("Arial Rounded MT Bold", 24));
			...
			Button eclipseScientificComputing = new Button(" Scientific ", new ImageView(image)); eclipseScientificComputing.setTranslateX(X); eclipseScientificComputing.setTranslateY(Y+=100); eclipseScientificComputing.setFont(new Font("Arial Rounded MT Bold", 24));
			...
			Button eclipseModel = new Button(" Modeling Tools ", new ImageView(image)); eclipseModel.setTranslateX(X); eclipseModel.setTranslateY(Y+=100); eclipseModel.setFont(new Font("Arial Rounded MT Bold", 24));
			...
			Button eclipsePHP = new Button(" PHP ", new ImageView(image)); eclipsePHP.setTranslateX(X); eclipsePHP.setTranslateY(Y+=100); eclipsePHP.setFont(new Font("Arial Rounded MT Bold", 24));
	 ...
	 Y = 0;	Button eclipseRCPansRAP = new Button(" RCP & RAP ", new ImageView(image)); eclipseRCPansRAP.setTranslateX(X+=340); eclipseRCPansRAP.setTranslateY(Y+=25); eclipseRCPansRAP.setFont(new Font("Arial Rounded MT Bold", 24));
			...
			Button eclipseJAVAandDSL = new Button(" Java & DSL ", new ImageView(image)); eclipseJAVAandDSL.setTranslateX(X); eclipseJAVAandDSL.setTranslateY(Y+=100); eclipseJAVAandDSL.setFont(new Font("Arial Rounded MT Bold", 24));
			...
			Button eclipseJAVA = new Button(" Java ", new ImageView(image)); eclipseJAVA.setTranslateX(X); eclipseJAVA.setTranslateY(Y+=100); eclipseJAVA.setFont(new Font("Arial Rounded MT Bold", 24));
		    ...
		    Button eclipseJAVAandWEB = new Button(" Java and Web ", new ImageView(image)); eclipseJAVAandWEB.setTranslateX(X); eclipseJAVAandWEB.setTranslateY(Y+=100); eclipseJAVAandWEB.setFont(new Font("Arial Rounded MT Bold", 24));
			...
			Button eclipseScout = new Button(" IDE For Scout ", new ImageView(image)); eclipseScout.setTranslateX(X); eclipseScout.setTranslateY(Y+=100); eclipseScout.setFont(new Font("Arial Rounded MT Bold", 24));
		...
		FileInputStream eclipseBackgroundInputStream = new FileInputStream("bin/background/eclipse.png");

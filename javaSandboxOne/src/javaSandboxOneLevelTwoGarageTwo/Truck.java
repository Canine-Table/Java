...
public class Truck
	{
		...
		Truck(String _Model, String _Make)
			{
				this.setModel(_Model);
				this.setMake(_Make);
			}
		
		Truck(String _Model, String _Make, int _Year)
			{
				this.setModel(_Model);
				this.setMake(_Make);
				this.setYear(_Year);
		...
		Truck(String _Model, String _Make, String _Color, int _Year)
			{
				this.setModel(_Model);
		...
		Truck(String _Model, String _Make, String _Color, String _Style, int _Year)
			{
				this.setModel(_Model);
				this.setColor(_Color);
				this.setMake(_Make);
		...
		Truck(String _Model, String _Make, String _Color, int _Year, int _Price)
			{
				this.setModel(_Model);
				this.setColor(_Color);
				this.setMake(_Make);
		...
		Truck(String _Model, String _Make, String _Color, String _Style, int _Year, int _Price, float _HorsePower, float _Efficiency, float _Millage)
			{
				this.setModel(_Model);
				this.setColor(_Color);
				this.setMake(_Make);

...
public class DragAndDropMain extends JPanel 
	{
		...
		protected class DragAndDrop extends JFrame
			{
				DragAndDropMain dragAndDropMain = new DragAndDropMain();
				DragAndDrop()
					{
						this.setTitle("Drag & Drop");
						this.setSize(512,512);
						this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
						this.add(dragAndDropMain);
		...
		public static void main(String[] args)
			{
			 new DragAndDropMain().new DragAndDrop();
			}
	}